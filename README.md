...
## 5. 느낀 점
- Vite를 처음 사용해 보았는데, git bash에서 방향키를 사용할 수가 없어서 여러번 app 설치를 시도해 보다가 [Stack overflow](https://stackoverflow.com/questions/55753151/cant-use-arrow-keys-in-git-bash-windows)에서 답을 찾았다.
...
SPA'a full page reload' 발생하지 않도록 하는 것이 SPA의 기본 원칙에 부합하는 것이라는 것을 알게 됐다.
